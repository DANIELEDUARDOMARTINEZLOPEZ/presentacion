...
<section>
   ...
   <h3 style="font-size: 40px;">Los códigos cíclicos son códigos de bloque lineales especiales con una propiedad adicional. En un código cíclico, si una palabra de código se desplaza (rota) cíclicamente, el resultado es otra palabra de código</h3>
</section>
...
<section>
   ...
   <h3 style="font-size: 40px;">Un patrón de ceros y unos puede representarse como un polinomio con coeficientes de 0 y 1. La potencia de cada término muestra la posición del bit; el coeficiente muestra el valor del bit.</h3>
</section>
...
<section>
   ...
   <h3 style="font-size: 40px;">La multiplicación de polinomios implica aplicar la propiedad distributiva, y es esencial para calcular la palabra de código resultante en sistemas de corrección de errores y La división de polinomios se utiliza para obtener el resto, que es clave en el cálculo de la verificación de errores en códigos cíclicos.</h3>
</section>
...
<section>
   <h1 style="font-size: 30px;">10.5 Suma de verificacion</h1>
   <h3 style="font-size: 40px;">Al igual que los códigos lineales y cíclicos, la suma de comprobación se basa en el concepto de redundancia. Varios protocolos aún utilizan la suma de comprobación para la detección de errores, como veremos en capítulos posteriores, aunque la tendencia es reemplazarla por un CRC. Esto significa que el CRC también se utiliza en capas distintas a la capa de enlace de datos.</h3>
</section>

<section>
   <h1 style="font-size: 30px;">Suma de comprobación de Internet</h1>
   <h3 style="font-size: 40px;">La naturaleza de la suma de comprobación (tratar las palabras como números y sumarlas y complementarlas) es muy adecuada para la implementación de software. Se pueden escribir programas cortos para calcular la suma de comprobación en el sitio receptor o para verificar la validez del mensaje en el sitio receptor.</h3>
</section>
